...
const cart = require('../config/data/cart.json');
    ...
    return {
        ...
        before(app, server) {
            ...
            app.get('/api/car', (req, res) => {
                const car = require('../public/mock/car.js')
                res.send({ code: 0, car })
            });
            app.get('/api/eyecat', (req, res) => {
                const cat = require('../public/mock/cateye.js')
                res.send({ code: 0, cat })
            });
            app.get('/api/shop', (req, res) => {
                const shop = require('../public/mock/shop.js');
            ...
            const { provinceArr, city } = require('../public/mock/data.js')
            app.get('/api/cityList', (req, res) => {
                res.send({ code: 0, provinceArr, city })
            });
        },
    };
};